...
const Senkrecht = (props: CanvasElementProps<CanvasElementConfig, CanvasElementData>) => {
  const { data } = props;
      ...
      >
        ...
        <defs>
          ...
          <clipPath id={`clip-${uniqueId}`}>
            <path d="M 75 0 H 125 V 200 H 75 Z" />
          </clipPath>
        </defs>
        ...
        <path
          d="M 75 0 H 125 V 200 H 75 Z"
          style={{ fill: data?.backgroundImage ? `url(#image-${uniqueId})` : data?.backgroundColor }}
        />

        {/* Border */}
        <path d="M 75 0 H 125 V 200 H 75 Z" clipPath={`url(#clip-${uniqueId})`} className={styles.elementBorder} />
      </svg>
...
export const senkrechtItem: CanvasElementItem<CanvasElementConfig, CanvasElementData> = {
  id: 'senkrecht',
  name: 'Security Lane - senkrecht',
